...
Flat ~61ms in a live hand-tracking sidecar with virtually no tail. 1.4x faster than PyTorch MPS in isolated benchmarks. Sub-millimeter parity against PyTorch.
