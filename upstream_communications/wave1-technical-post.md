...
- In our live hand-tracking sidecar, MLX holds flat ~60ms with virtually no tail — p95 stays at ~63ms (5% spread). That's the consistency you need to use 3D hand pose as a real-time control primitive, not just a batch inference model.
